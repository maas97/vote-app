...
@Module({
    ...
    providers: [PollsService, PollsRepository], // here we put the services we want this module and the rest of (imports/controllers/other providers) to be able to access it and use it
    exports:[]
})
